            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="about__content">
                        ...
                        <a href="{{ asset('frontend/assets/pdf/PROFILE ADECEL RUSTY MABIALA 17-06-23.pdf') }}" download="resume.pdf" class="btn">Download my resume</a>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="about__skill__item">
                                                <h5 class="title">Software Development Expertise</h5>
                                                <div class="progress">
                                        ...
                                        <div class="col-md-6">
                                            <div class="about__skill__item">
                                                <h5 class="title">Web Development Mastery</h5>
                                                <div class="progress">
                                        ...
                                        <div class="col-md-6">
                                            <div class="about__skill__item">
                                                <h5 class="title">System Architecture and Integration</h5>
                                                <div class="progress">
                                        ...
                                        <div class="col-md-6">
                                            <div class="about__skill__item">
                                                <h5 class="title">Maintenance and Support</h5>
                                                <div class="progress">
                                        ...
                                        <div class="col-md-6">
                                            <div class="about__skill__item">
                                                <h5 class="title">Quality Assurance and Testing</h5>
                                                <div class="progress">
                                        ...
                                        <div class="col-md-6">
                                            <div class="about__skill__item">
                                                <h5 class="title">Problem Solving and Troubleshooting</h5>
                                                <div class="progress">
                                        ...
                                        <div class="col-md-6">
                                            <div class="about__skill__item">
                                                <h5 class="title">Communication and Collaboration</h5>
                                                <div class="progress">
                                        ...
                                        <div class="col-md-6">
                                            <div class="about__skill__item">
                                                <h5 class="title">Continuous Learning and Adaptability</h5>
                                                <div class="progress">
